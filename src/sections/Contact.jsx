...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "mayankpandeyji2001@gmail.com",
    href: "mailto:mayankpandeyji2001@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91-817-837-0793",
    href: "tel:+918178370793",
  },
  {
    icon: MapPin,
    label: "Location",
    ...
    <section id="contact" className="py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-5xl mx-auto">
          {/* Contact Form */}
          <div className="glass p-6 md:p-8 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300 w-full">
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400 w-full">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                need a full-stack engineer for a product, a freelance consultant,
                or someone to join your team — let's talk!
              </p>
            </div>
          </div>
        </div>
